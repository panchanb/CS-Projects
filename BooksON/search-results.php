...
<?php
	...
	echo "<div class='container text-center'>";
		echo "<h1 class = 'heading text-success'>Search results for <font color=blue> '$keyword' </font></h1>";
		echo "</div>";

	$query = "select * from Category c, Books b where c.category_id = b.category_id and b.title like '%$keyword%'";
	$result = @mysqli_query($conn, $query);
